    ...
    <body>
        ...
        <div id="show-task" class="content scaffold-show" role="main">
            ...
            <ol class="property-list">
                <f:display bean="task" property="title"/>
                <f:display bean="task" property="event"/>                
                <f:display bean="task" property="notes"/>
                <f:display bean="task" property="assignedTo"/>
                <f:display bean="task" property="dueDate"/>
                <f:display bean="task" property="completed"/>
            </ol>
