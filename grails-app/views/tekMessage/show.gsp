...
<html>
    ...
    <body>
        ...
        <div id="show-tekMessage" class="content scaffold-show" role="main">
            ...
            <f:display bean="tekMessage" />
            <g:form resource="${this.tekMessage}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tekMessage}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
