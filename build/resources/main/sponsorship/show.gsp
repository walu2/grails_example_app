...
<html>
    ...
    <body>
        ...
        <div id="show-sponsorship" class="content scaffold-show" role="main">
            ...
            <f:display bean="sponsorship" />
            <g:form resource="${this.sponsorship}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sponsorship}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
