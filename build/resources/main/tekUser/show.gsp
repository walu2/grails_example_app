...
<html>
    ...
    <body>
        ...
        <div id="show-tekUser" class="content scaffold-show" role="main">
            ...
            <f:display bean="tekUser" />
            <g:form resource="${this.tekUser}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tekUser}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
